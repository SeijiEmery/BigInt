...
//   all unittest code.
//
// UNITTEST_REPORT_ON_SUCCESS (#define / #undef)
...
//
    ...
    #define UNITTEST_END_METHOD(name) }

    #define RUN_UNITTEST(args...)
    #define RUN_UNITTEST_MAIN(args...)
